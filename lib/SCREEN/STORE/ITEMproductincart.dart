...
class ITEMproductincart extends StatefulWidget {
  final Product food;
  final double width;
  final VoidCallback onTap;
  const ITEMproductincart({Key? key, required this.food, required this.width, required this.onTap}) : super(key: key);

  @override
  State<ITEMproductincart> createState() => _ITEMfoodincartState();
}

class _ITEMfoodincartState extends State<ITEMproductincart> {
  @override
