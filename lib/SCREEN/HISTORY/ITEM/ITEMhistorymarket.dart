...
class ITEMhistorymarket extends StatefulWidget {
  final foodOrder order;
  final double width;
  final double height;
  final VoidCallback onTap;
  const ITEMhistorymarket({Key? key, required this.order, required this.width, required this.height, required this.onTap}) : super(key: key);

  @override
  State<ITEMhistorymarket> createState() => _ITEMhistoryfoodState();
}

class _ITEMhistoryfoodState extends State<ITEMhistorymarket> {
  bool check = true;
